<?php
    if (isset($_GET['inputSearch'])) {
        ...
        for($i=0;$i<count($data);$i++) {
            ...
            .$price1." VND</p><p style=\"margin-top: -2px;margin-bottom: 5px;\">Quantity in stock: ".$data[$i]['SoLuongTon']."</p><button class=\"btn2\" onclick=\"deleteProduct(".$data[$i]['MaSP'].")\">Delete</button><button class=\"btn2\" onclick=\"editInfo(".$data[$i]['MaSP'].")\">Edit</button></div>";
